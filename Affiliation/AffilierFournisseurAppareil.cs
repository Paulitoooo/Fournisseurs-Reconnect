...
namespace Fournisseurs_Reconnect.Affiliation
{
    public partial class AffilierFournisseurAppareil : Form
    {
        ...
        private void boutonAffilier_Click(object sender, EventArgs e)
        {
            ...
            Appareils appareilsAffilié = new Appareils(GetIdAppareil(listeModèles.Text, listeMarques.Text, listeType.Text, Int32.Parse(listeTailleStockage.Text)),
                listeModèles.Text,
            ...
            float lePrix = float.Parse(textBoxPrix.Text);
            ...
            {
                MessageBox.Show("Veillez à ce que le prix saisi soit un nombre");
            }
        }
    }
}
